...
"""Use Scapy to send a UDP header to a host.

Kind of like pinging a device by using UDP.
"""
...
def main(host_ip4, port_dst, ephem, count):
    ...
    if count < 1:
        ...
        while True:
            ...
            send_udp(host_ip4, port_dst, port_src, i)
            i += 1
            sleep(TIME_SLEEP)
    else:
        ...
        for i in range(count):
            if ephem:
                ...
                port_src = NUM_PORT_SRC
            send_udp(host_ip4, port_dst, port_src, i+1)
            sleep(TIME_SLEEP)
...
if __name__ == "__main__":
    ...
    port_dst_help = "UDP destination port to set."
