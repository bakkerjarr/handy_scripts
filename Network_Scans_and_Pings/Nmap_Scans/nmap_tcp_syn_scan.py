...
class TCPSYNScan:
    ...
    def start_scan(self):
        ...
        """
        print "[?] Starting TCP SYN scan on host {0}".format(self._host)
...
if __name__ == "__main__":
    ...
    program_desc = "Use Nmap to perform a TCP SYN Scan on a host."
    ...
    # Let's scan!
    tcp_scan = TCPSYNScan(args.host_ip4, ports)
    tcp_scan.start_scan()
