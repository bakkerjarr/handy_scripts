...
class TCPWINScan:
    ...
    def start_scan(self):
        """Start the TCP WIN scan.
        """
        print "[?] Starting TCP WIN scan on host {0}".format(self._host)
...
if __name__ == "__main__":
    ...
    program_desc = "Use Nmap to perform a TCP WIN Scan on a host."
    ...
    # Let's scan!
    tcp_scan = TCPWINScan(args.host_ip4, ports)
    tcp_scan.start_scan()
